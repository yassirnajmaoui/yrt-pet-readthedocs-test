 ...
 * *************************************************************************************/
void ImageWarperFunction::warp(GCImage* image, int frameId) const
{
 ...
 * *************************************************************************************/
void ImageWarperFunction::inverseWarp(GCImage* image, int frameId) const
{
	auto tmpCopy = std::make_unique<GCImageOwned>(image->getParams());
	tmpCopy->allocate();
